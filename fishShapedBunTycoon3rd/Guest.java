...
//    }
    ...
    public void guestBlankTimer(){
        ...
        guestBlankTimer = new javax.swing.Timer(1000, new ActionListener() {
            int count = 10;
            @Override
    ...
    public void guestBlankTimerForPlace2(){
        ...
        guestBlankTimerForPlace2 = new javax.swing.Timer(1000, new ActionListener() {
            int count = 10;
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void guestWaitingTimer(){
        guestWaitingTimer = new javax.swing.Timer(1000, new ActionListener() {
    ...
    public void guestWaitingTimerForPlace2(){
        guestWaitingTimerForPlace2 = new javax.swing.Timer(1000, new ActionListener() {
            int count = demandNumberOfFish;
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void guestGetMadTimer(){
        guestGetMadTimer = new javax.swing.Timer(1000, new ActionListener() {
            int count = demandNumberOfFish;
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void guestGetMadTimerForPlace2(){
        guestGetMadTimerForPlace2 = new javax.swing.Timer(1000, new ActionListener() {
            int count = demandNumberOfFish;
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void guestLastWordTimer(){
        guestLastWordTimer = new javax.swing.Timer(1000, new ActionListener() {
            int count = 2;
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void guestLastWordTimerForPlace2(){
        guestLastWordTimerForPlace2 = new javax.swing.Timer(1000, new ActionListener() {
            int count = 2;
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void guestSellFishBunTimer(){
        guestSellFishBunTimer = new javax.swing.Timer(1000, new ActionListener() {
            int count = 2;
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void guestSellFishBunTimerForPlace2(){
        guestSellFishBunTimerForPlace2 = new javax.swing.Timer(1000, new ActionListener() {
            int count = 2;
            @Override
            public void actionPerformed(ActionEvent e) {
