...
public class Japan  extends Countries{
	...
	static String name ="¡¡¡¡ÀÏº»¡¡¡¡¡¡";
	static String own1p,own2p;
	String ownName ="¡¡¡¡ÀÏº»¡¡¡¡¡¡";
	String p1_own  ="¡¡¡ÙÀÏº»¡Ù¡¡¡¡¡¡";
	String p2_own  ="¡¡¡ÚÀÏº»¡Ú¡¡¡¡¡¡";
	...
	public void own1p() {
		...
		name=name.replaceAll("¡¡¡¡ÀÏº»¡¡¡¡¡¡","¡¡¡ÙÀÏº»¡Ù¡¡¡¡¡¡");
		
	}//own1p
	
	public void own2p() {
		
		name=name.replaceAll("¡¡¡¡ÀÏº»¡¡¡¡¡¡","¡¡¡ÚÀÏº»¡Ú¡¡¡¡¡¡");
	...
	public void buyOwn1p() {
		...
		name=name.replaceAll("¡¡¡ÙÀÏº»¡Ù¡¡¡¡¡¡","¡¡¡ÚÀÏº»¡Ú¡¡¡¡¡¡");
		
	}
	
	public void buyOwn2p() {
		name=name.replaceAll("¡¡¡ÚÀÏº»¡Ú¡¡¡¡¡¡","¡¡¡ÙÀÏº»¡Ù¡¡¡¡¡¡");
	}
